class ContributionsController < ApplicationController
  ...
  def create
    ...
    flash[:success] = 'Aporte creado exitosamente.'
  ...
  def edit
    case params[:origin]
    when "CANCELLED"
      @contribution.cancel ? flash[:success] = 'Aporte anulado exitosamente.' : flash[:danger] = "Imposible anular egreso. Aporte #{ContributionDecorator.decorate(@contribution).status_name}."
      redirect_to contributions_url
    end
  end
  ...
  def update
    ...
    flash[:success] = 'Aporte actualizado exitosamente.'
    redirect_to contributions_url
  end

  def destroy
    @contribution.destroy
    redirect_to contributions_url, notice: 'Aporte eliminado exitosamente.'
  end
